...
class StructuredLoggerLayoutTest {
    ...
    void shouldConvertLogEventIntoStructuredLog() {
        ...
        String expectedLog = "{\"level\":\"INFO\",\"message\":\"This is my fancy log entry\",\"data\":[\"This is my " +
                "fancy log entry\"],\"source\":{\"classLoaderName\":\"classLoaderName\",\"moduleName\":null," +
